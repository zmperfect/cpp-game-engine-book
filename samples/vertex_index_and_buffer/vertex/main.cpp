...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUseProgram(program);
        {
            ...
            glVertexAttribPointer(vcol_location, 4, GL_FLOAT, false, sizeof(Vertex), reinterpret_cast<const float*>(kVertexs) + 3);
            ...
            glVertexAttribPointer(a_uv_location, 2, GL_FLOAT, false, sizeof(Vertex), (reinterpret_cast<const float*>(kVertexs)) + 3 + 4);
